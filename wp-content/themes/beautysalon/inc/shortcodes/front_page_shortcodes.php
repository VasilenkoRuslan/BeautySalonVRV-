...
/* This is Header board at front page */
function header_board_shortcode()
{
...
add_shortcode('fp-header-board', 'header_board_shortcode');

/* This is Block "w" icons */
function block_w_shortcode()
{
...
add_shortcode('block-w-items', 'block_w_shortcode');

/* This is Block "dg" */
function block_dg_shortcode()
{
...
add_shortcode('block-dg-items', 'block_dg_shortcode');
...
add_shortcode('block-info', 'block_info');

/* This is Block our awesome client icons */
...
add_shortcode('logo_clients', 'get_block_logo_clients');
