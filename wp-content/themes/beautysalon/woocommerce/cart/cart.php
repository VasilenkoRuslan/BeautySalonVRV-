...
<form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post" id="data">
	<?php do_action('woocommerce_before_cart_table'); ?>
	<section id="cart_items">
		<div class="container">
			<div class="table-responsive cart_info">
				<table class="table table-condensed shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
					<thead>
					<tr class="cart_menu">
					...
					foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item) {
						...
						if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_cart_item_visible', true, $cart_item, $cart_item_key)) {
							...
							<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
								...
								<td class="cart_description product-name" data-title="<?php esc_attr_e('Product', 'woocommerce'); ?>">
									<h4>
									<?php
									if (!$product_permalink) {
								...
								<td class="cart_price product-price" data-title="<?php esc_attr_e('Price', 'woocommerce'); ?>">
									<p>
									<?php
